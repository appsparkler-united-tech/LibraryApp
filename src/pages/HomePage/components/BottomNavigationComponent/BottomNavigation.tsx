...
const BottomNavigation = () => {
  ...
  <button className="flex flex-col items-center gap-0.5">
  <CiCirclePlus size={24}/><span className="dock-label text-pretty font-light">Offer</span>
  </button>

  <button className="flex flex-col items-center gap-0.5">
  <CiChat1 size={24}/><span className="dock-label text-pretty font-light">Chat</span>
  </button>

  <button className="flex flex-col items-center gap-0.5">
  <CiUser size={24}/><span className="dock-label text-pretty font-light">Me</span>
  </button>
</div>
  );
};
